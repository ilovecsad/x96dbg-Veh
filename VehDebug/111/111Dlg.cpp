...
CMy111Dlg::CMy111Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MY111_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CMy111Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMy111Dlg::OnBnClickedButton1)
END_MESSAGE_MAP()
